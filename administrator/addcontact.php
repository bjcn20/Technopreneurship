                                        ...
                                        <div class="card card-body">
                                            ...
                                            <div class="row py-3">
                                                <div class="input-group col">
                                                    ...
                                                    <input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="11" class="form-control" placeholder="Contact Number" aria-label="ContactNumber" aria-describedby="ContactNumber" name="contactnumber" required>
                                                </div>
                                                <div class="input-group col">
                                                    <span class="input-group-text" id="SchoolName">
                                                        <i class="fa fa-university" aria-hidden="true"></i>
                                                    </span>
                                                    <input type="text" class="form-control" placeholder="School Name" aria-label="SchoolName" aria-describedby="SchoolName" name="schoolname" required>
                                                </div>
                                            </div>
                                            <div class="row py-3">
                                                <div class="col">
